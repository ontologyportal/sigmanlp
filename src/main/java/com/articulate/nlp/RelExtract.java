 ...
 * Process sentences through the relation extraction rules.
 */
public class RelExtract {
    ...
    /** *************************************************************
     * Build the sample formula from the given relation, so that it
     * can be run through NLG.
     */
    ...
    /** *************************************************************
     * Remove the root() predicate terms generated by CoreNLP
     */

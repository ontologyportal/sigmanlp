...
import semRewrite.Clausifier;
import semRewrite.Lexer;
import semRewrite.Rule;
...
public class RuleSet {
    ...
    public RuleSet parse(Lexer lex) {
        ...
        RuleSet rs = new semRewrite.RuleSet();
    ...
    /** ***************************************************************
     */
    public static semRewrite.RuleSet readFile(String fname) throws Exception {
        ...
        try {
            ...
            semRewrite.RuleSet rs = new semRewrite.RuleSet();
            return rs.parse(lex);
        }
        catch (Exception ex) {
            exThr = ex;

...
import static semRewrite.EntityType.PERSON;
...
public class Interpreter {
    ...
    private ArrayList<semRewrite.Graph> userGraphs = new ArrayList<semRewrite.Graph>();
...
//                String newDependency = modifyDependencyElem(dependency, verbNum);
    ...
    public String fromKIFClauses(ArrayList<String> kifcs) {
        ...
        if (inference) {
            ...
            if (question) {
                ...
                String answer = semRewrite.Interpreter.formatAnswer(query, inferenceAnswers, kb);
    ...
    public static String formatAnswer(Formula query, List<String> inferenceAnswers, KB kb) {
        ...
        if (semRewrite.Interpreter.isOuterQuantified(query)) {
            try {
...
//                return actual;
    ...
    public static void testPreserve() {
        ...
        interp = new semRewrite.Interpreter();

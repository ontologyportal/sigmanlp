...
public class Clause {
    ...
    /** *************************************************************
     */
    public semRewrite.Clause deepCopy() {
        
        semRewrite.Clause newd = new semRewrite.Clause();
        for (int i = 0; i < disjuncts.size(); i++) 
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof semRewrite.Clause))
            return false;
        semRewrite.Clause d = (semRewrite.Clause) o;
     ...
     */
    public void copyBoundFlags(semRewrite.Clause d) {
     ...
     * to this clause.
     */
    public semRewrite.Clause applyBindings(HashMap<String,String> bindings) {
        
        semRewrite.Clause c = new semRewrite.Clause();
        for (int i = 0; i < disjuncts.size(); i++) {
            Literal l = disjuncts.get(i);
     ...
     */
    public HashMap<String,String> unify(semRewrite.Clause d) {

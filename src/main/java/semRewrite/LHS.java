...
public class LHS {
    ...
    public semRewrite.LHS lhs1;
    public semRewrite.LHS lhs2;
    ...
    /** ***************************************************************
     */
    public semRewrite.LHS deepCopy() {

        semRewrite.LHS newlhs = new semRewrite.LHS();
     ...
     * Lexer.
     */
    public static semRewrite.LHS parse(Lexer lex, int startLine) {

        String errStart = "Parsing error in " + RuleSet.filename;
        String errStr;
        semRewrite.LHS lhs = new semRewrite.LHS();
        try {
            ...
            if (lex.testTok(Lexer.Plus)) {
               ...
               // return lhs;
                ...
                lhs.lhs1 = semRewrite.LHS.parse(lex,startLine);
                ...
                lex.next();
                lhs.lhs2 = semRewrite.LHS.parse(lex,startLine);
            ...
            if (lex.testTok(Lexer.Comma)) {
                semRewrite.LHS left = new semRewrite.LHS();

...
public class NounSubstitutor extends SimpleSubstitutorStorage {
    ...
    private void initialize(List<CoreLabel> labels) {
        ...
        Map<semRewrite.substitutor.CoreLabelSequence, semRewrite.substitutor.CoreLabelSequence> groupsFull = parseGroupsAndCollectRoots(labels);
        addGroups(groupsFull);
    }

    /** **************************************************************
     */
    private Map<semRewrite.substitutor.CoreLabelSequence, semRewrite.substitutor.CoreLabelSequence> parseGroupsAndCollectRoots(List<CoreLabel> labels) {

        System.out.println("Info in NounSubstitutor.parseGroupsAndCollectRoots(): " + labels);
        Map<semRewrite.substitutor.CoreLabelSequence, semRewrite.substitutor.CoreLabelSequence> sequences = Maps.newHashMap();

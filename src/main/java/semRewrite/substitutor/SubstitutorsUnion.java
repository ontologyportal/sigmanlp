...
import static semRewrite.substitutor.CoreLabelSequence.EMPTY_SEQUENCE;
 ...
 * All the search/contains calls will return success results if any of united substitutor can do that.
  */
public class SubstitutorsUnion implements semRewrite.substitutor.ClauseSubstitutor {

    final List<semRewrite.substitutor.ClauseSubstitutor> substitutors;

    public SubstitutorsUnion(List<semRewrite.substitutor.ClauseSubstitutor> substitutors) {
    ...
    /** ***************************************************************
     */
    public static semRewrite.substitutor.ClauseSubstitutor of(ClauseSubstitutor... substitutors) {
        semRewrite.substitutor.SubstitutorsUnion combinator = new semRewrite.substitutor.SubstitutorsUnion(

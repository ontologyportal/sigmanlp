...
public interface ClauseSubstitutor {
     ...
     */
    Optional<semRewrite.substitutor.CoreLabelSequence> getGroupedByFirstLabel(CoreLabel label);

    /** ***************************************************************
     * Searches for referenced group by any label included into the key
     */
    semRewrite.substitutor.CoreLabelSequence getGrouped(CoreLabel key);

...
public class EntityTypeParser {
    ...
    public static final semRewrite.EntityTypeParser NULL_PARSER = new semRewrite.EntityTypeParser();
    Multimap<String, semRewrite.EntityType> parsedEntities = HashMultimap.create();
    ...
    public EntityTypeParser(Annotation document) {
        ...
        if (coreMaps == null) {
            ...
            for (CoreMap coreMap : coreMaps) {
                Optional<semRewrite.EntityType> type = Enums.getIfPresent(semRewrite.EntityType.class, coreMap.get(CoreAnnotations.EntityTypeAnnotation.class));
                if (type.isPresent()) {
    ...
    /** ***************************************************************
     */
    public Collection<semRewrite.EntityType> getEntityTypes(String entity) {

...
public class RHS {
    ...
    /** ***************************************************************
     */
    public semRewrite.RHS deepCopy() {
        
        semRewrite.RHS rhs = new semRewrite.RHS();
        if (form != null)
     ...
     */
    public static semRewrite.RHS parse(Lexer lex, int startLine) {
     ...
     */
    public semRewrite.RHS applyBindings(HashMap<String,String> bindings) {

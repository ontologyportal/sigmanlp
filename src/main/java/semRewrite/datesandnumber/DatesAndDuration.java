...
import semRewrite.datesandnumber.Utilities;
...
public class DatesAndDuration {
	 ...
	 */
	 ...
	 /** ***************************************************************
		 */
	 private void populateDateInfo(semRewrite.datesandnumber.DateInfo tempDate, String year, String month, String day, String weekDay) {
		 if(day != null) {
			 tempDate.setDay(day);
		 }
		 if(month != null) {
	 ...
	 private void addDateToList(String day, String month, String year, String weekDay, int index, Utilities utilities) {
		 ...
		 semRewrite.datesandnumber.DateInfo tempDate = new semRewrite.datesandnumber.DateInfo();
	 ...
	 private void addInfoToDateList(List<Tokens> tempDateList, Utilities utilities) {
		 semRewrite.datesandnumber.DateInfo tempDateInfo = new semRewrite.datesandnumber.DateInfo();
	 ...
	 /** ***************************************************************
		 */
	 public List<semRewrite.datesandnumber.DateInfo> generateSumoDateTerms(Utilities utilities, List<Tokens> tempDateList){

		 if(!tempDateList.isEmpty()) {
			 addInfoToDateList(tempDateList, utilities);
			 tempDateList.clear();
		 }
		List<semRewrite.datesandnumber.DateInfo> dateList = utilities.datesList;
		for (semRewrite.datesandnumber.DateInfo date : dateList) {
	 ...
	 public Tokens processDuration(Tokens token, Utilities utilities, Tokens prevDurationToken) {
		 ...
		 if (token.getWord().matches("[0-9]{4}\\-[0-9]{4}")) {
			 ...
			 semRewrite.datesandnumber.DateInfo newDateInfo = new semRewrite.datesandnumber.DateInfo();
			 ...
			 semRewrite.datesandnumber.DateInfo endDateInfo = new semRewrite.datesandnumber.DateInfo();
	 ...
	 /** ***************************************************************
		 */
	 public void generateDurationSumoTerms(IndexedWord tempParent, Utilities utilities, semRewrite.datesandnumber.DateInfo startDateInfo, DateInfo endDateInfo) {

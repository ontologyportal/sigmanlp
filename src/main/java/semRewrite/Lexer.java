...
public class Lexer {
    ...
    private static void testLex() {
        ...
        semRewrite.Lexer lex1 = new semRewrite.Lexer(example1);
        semRewrite.Lexer lex2 = new semRewrite.Lexer(example2);
        try {
    ...
    private static void testString() {
        ...
        semRewrite.Lexer lex1 = new semRewrite.Lexer(example3);
        try {
    ...
    private static void testAcceptLit() {
        ...
        semRewrite.Lexer lex = new semRewrite.Lexer(example1);
        try {
            lex.acceptLit("sense");
            lex.acceptLit("(");
    ...
    private static void testErrors() {
        ...
        semRewrite.Lexer lex = null;
        try {
            lex = new semRewrite.Lexer(example1);
            lex.look(); 
        }
        catch (Exception e) {
            System.out.println(e.getMessage());
    ...
    private static void testAcceptClause() {
        ...
        semRewrite.Lexer lex = new semRewrite.Lexer(example4);
        try {
    ...
    private static void testAcceptClause2() {
        ...
        System.out.println("-------------------------------------------------");
        System.out.println("INFO in Lexer.testAcceptClause()");
        semRewrite.Lexer lex = new semRewrite.Lexer(example5);
        try {
            System.out.println(lex.next());
            System.out.println(lex.next());
            System.out.println(lex.next());
    ...
    public static void main(String[] args) {
        ...
        semRewrite.Interpreter interp = new Interpreter();
        if (args != null && args.length > 1 && args[0].equals("-s")) {
            semRewrite.Lexer lex = new semRewrite.Lexer(args[1]);
            try {
                System.out.println(lex.lex());
                lex = new semRewrite.Lexer(args[1]);

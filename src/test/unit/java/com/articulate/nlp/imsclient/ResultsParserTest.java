 ...
 * Author: Prasad Nirantar
 */
public class ResultsParserTest extends UnitTestBase {
    ...
    public void testSimpleSentence() throws Exception {
    		...
    		assertEquals(new ParseResult("I", null), result.get(0));
    		...
    		assertEquals(new ParseResult("am", totalSenses), result.get(1));
    		...
    		assertEquals(new ParseResult("interested", totalSenses), result.get(2));

    		assertEquals(new ParseResult("in the", null), result.get(3));
    		...
    		totalSenses = new ArrayList<>();
    		totalSenses.add(senses);
    		assertEquals(new ParseResult("interest", totalSenses), result.get(4));

    		assertEquals(new ParseResult("rates of this", null), result.get(5));
    		...
    		totalSenses = new ArrayList<>();
    		totalSenses.add(senses);
    		assertEquals(new ParseResult("bank", totalSenses), result.get(6));

    		assertEquals(new ParseResult(".", null), result.get(7));
    }
    ...
    public void testMultipleLength() throws Exception {
		...
		assertEquals(new ParseResult("am", senses), result.get(0));
    }

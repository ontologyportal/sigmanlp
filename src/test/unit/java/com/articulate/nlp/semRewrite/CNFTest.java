...
public class CNFTest {
    ...
    public void testUnify() {
        ...
        System.out.println("INFO in CNF.testUnify(): bindings: " + bindings);
        System.out.println("INFO in CNF.testUnify(): cnf " + cnf);
    ...
    public void testUnify2() {
        ...
        System.out.println("INFO in CNF.testUnify(): cnf " + cnf);
        assertEquals("Xsense(212345678,Foo)",cnf.toString());
    }
    ...
    public void testUnify5() {
        ...
        System.out.println("INFO in CNF.testUnify(): cnf1 " + cnf1);
        System.out.println("INFO in CNF.testUnify(): bindings: " + cnf1.unify(cnf));
        assertEquals("Xnsubj(drives-2,John-1), root(ROOT-0,drives-2), Xsumo(Transportation,drives-2), sumo(Human,John-1)",cnf.toString());
    }
    ...
    public void testUnify8() {
        ...
        assertEquals("{?Y=1980, ?T=time-1, ?D=5, ?M=July, ?V=was-3}",cnf4.unify(cnf5).toString());
    }

 ...
 * FIXME: Generally we prefer testing SemRewrite rules without relying on the formula string.
 * (See SemRewriteTest.java.) We should use the
 * approach in this test class only when the target rule is being triggered, but the RHS
 * does not appear in the interpretCNF result.
 */

...
public class RulePrepAboutRefersToIntegrationTest extends IntegrationTestBase {
    ...
    /****************************************************************
     */
    private void doTest(String sent, String input, Set<String> expected) {
        ...
        System.out.println("RulePrepAboutRefersToIntegrationTest: expected: " + (new TreeSet(expected)));
        if (cleanedActual.containsAll(expected))
            System.out.println("RulePrepAboutRefersToIntegrationTest: pass");
        else
            System.out.println("RulePrepAboutRefersToIntegrationTest: fail");
        assertTrue(cleanedActual.containsAll(expected));
    }
    ...
    public void testAnnounceAbout() {
        ...
        String sent = "John announced about his plan.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance announce-2 Disseminating) (refers announce-2 plan-6))");
    ...
    public void testAskAbout() {
        ...
        String sent = "John asked about my opinion.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance ask-2 Questioning) (refers ask-2 opinion-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testBeAbout() {
        ...
        String sent = "Section Five is about the impact.";
        String input = "root(ROOT-0, be-3), nsubj(be-3, Section-1), num(Section-1, five-2), " +
                "det(impact-6, the-5), prep_about(be-3, impact-6), sumo(Text, Section-1), " +
                "sumo(Impacting, impact-6), number(SINGULAR, Section-1), tense(PRESENT, be-3), number(SINGULAR, impact-6)";
        Set<String> expected = Sets.newHashSet("(and (instance impact-6 Impacting) (refers Section-1 impact-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testComplainAbout() {
        ...
        String sent = "They seldom complain about unsafe work environments.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance complain-3 Expressing) (refers complain-3 work-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testExplainAbout() {
        ...
        String sent = "He explained about the reason.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance explain-2 ContentDevelopment) (refers explain-2 reason-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testForgetAbout() {
        ...
        String sent = "She forgot about the appointment.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance forget-2 Remembering) (refers forget-2 appointment-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testGeneralizeAbout() {
        ...
        String sent = "We tend to generalize about varied viewpoints.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance generalize-4 IntentionalPsychologicalProcess) (refers generalize-4 viewpoint-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testGossipAbout() {
        ...
        String sent = "It was so we could gossip about everyone who was not there.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance gossip-6 LinguisticCommunication) (refers gossip-6 everyone-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testHearAbout() {
        ...
        String sent = "We hear about the issue all the time.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance hear-2 Hearing) (refers hear-2 issue-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testInquireAbout() {
        ...
        String sent = "Many people are inquiring about the new policy.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance inquire-4 Questioning) (refers inquire-4 policy-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testLaughAbout() {
        ...
        String sent = "People are laughing about the incident.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance laugh-3 Laughing) (refers laugh-3 incident-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testMutterAbout() {
        ...
        String sent = "He muttered about al-Qaeda.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance mutter-2 Speaking) (refers mutter-2 al-Qaeda-4))");
        doTest(sent,input,expected);
    }
    ...
    public void testProclaimAbout() {
        ...
        String sent = "The Messiah proclaimed about a new world.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance proclaim-3 Declaring) (refers proclaim-3 world-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testReadAbout() {
        ...
        String sent = "He read about the accident in the newspaper.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance read-2 Reading) (refers read-2 accident-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testRememberAbout() {
        ...
        String sent = "He did not remember anything about the accident.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance remember-4 Remembering) (refers remember-4 accident-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testReportAbout() {
        ...
        String sent = "The journalist reported about the war.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance report-3 Stating) (refers report-3 war-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testSmileAbout() {
        ...
        String sent = "Proctor smiled about the encounter.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance smile-2 Smiling) (refers smile-2 encounter-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testSpeakAbout() {
        ...
        String sent = "They often spoke about the trip.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance speak-3 Speaking) (refers speak-3 trip-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testSpeakUpAbout() {
        ...
        String sent = "They should speak up about the problem.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance speak-3 Communication) (refers speak-3 problem-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testSpeculateAbout() {
        ...
        String sent = "Policy-makers have speculated about the cause.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance speculate-3 IntentionalPsychologicalProcess) (refers speculate-3 cause-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testStudyAbout() {
        ...
        String sent = "They study about biology.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance study-2 Investigating) (refers study-2 biology-4))");
        doTest(sent,input,expected);
    }
    ...
    public void testTalkAbout() {
        ...
        String sent = "Doctors talk about the epidemic.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance talk-2 ExpressingInLanguage) (refers talk-2 epidemic-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testUnderstandAbout() {
        ...
        String sent = "You should understand about the principles.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance understand-3 Interpreting) (refers understand-3 principle-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testExciteXAbout() {
        ...
        String sent = "Great teachers excite students about learning.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance excite-3 IntentionalPsychologicalProcess) (refers excite-3 learn-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testHearAnythingAbout() {
        ...
        String sent = "I did not hear anything about this before.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance hear-4 Hearing) (refers hear-4 this-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testKnowAnythingAbout() {
        ...
        String sent = "He did not know anything about the therapy.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance know-4 Interpreting) (refers know-4 therapy-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testRememberSomethingAbout() {
        ...
        String sent = "He remembered something about that family.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance remember-2 Remembering) (refers remember-2 family-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testAdviceAbout() {
        ...
        String sent = "He gave me an advice about exercise.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance advice-5 Requesting) (refers advice-5 exercise-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testAgreementAbout() {
        ...
        String sent = "We have an agreement about the policy.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance agreement-4 Agreement) (refers agreement-4 policy-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testAnxietyAbout() {
        ...
        String sent = "He has an anxiety about height.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance anxiety-4 Anxiety) (refers anxiety-4 height-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testArgumentAbout() {
        ...
        String sent = " The couple had arguments about insurance.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance argument-4 Argument) (refers argument-4 insurance-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testArticleAbout() {
        ...
        String sent = " He gave me an article about the experiment.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance article-5 Article) (refers article-5 experiment-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testAssumptionAbout() {
        ...
        String sent = " The nurses have assumptions about doctors.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance assumption-4 Supposition) (refers assumption-4 doctor-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testBookAbout() {
        ...
        String sent = " He gave me a book about the famous painter.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance book-5 Book) (refers book-5 painter-9))");
        doTest(sent,input,expected);
    }
    ...
    public void testConversationAbout() {
        ...
        String sent = " We had a conversation about the trip.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance conversation-4 Speaking) (refers conversation-4 trip-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testDebateAbout() {
        ...
        String sent = " There is an ongoing debate about the issue.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance debate-5 Debating) (refers debate-5 issue-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testDetailAbout() {
        ...
        String sent = " He did not give me any details about the requirements.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance detail-7 Fact) (refers detail-7 requirement-10))");
        doTest(sent,input,expected);
    }
    ...
    public void testDiscussionAbout() {
        ...
        String sent = " The discussion about the best option led to no conclusion.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance discussion-2 Text) (refers discussion-2 option-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testDocumentaryAbout() {
        ...
        String sent = " The documentary about Egypt was good.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance documentary-2 Documentary) (refers documentary-2 Egypt-4))");
        doTest(sent,input,expected);
    }
    ...
    public void testFactAbout() {
        ...
        String sent = " The article outlines facts about malnutrition.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance fact-4 Fact) (refers fact-4 malnutrition-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testHypothesisAbout() {
        ...
        String sent = " There are various hypotheses about the phenomenon.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance hypothesis-4 Stating) (refers hypothesis-4 phenomenon-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testInstructionAbout() {
        ...
        String sent = " Instructions about evacuation were not clear.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance instruction-1 Procedure) (refers instruction-1 evauation-3))");
        doTest(sent,input,expected);
    }
    ...
    public void testLanguageAbout() {
        ...
        String sent = " The painting represents a visual language about the topic.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance language-6 Language) (refers language-6 topic-9))");
        doTest(sent,input,expected);
    }
    ...
    public void testMeetingAbout() {
        ...
        String sent = " The meeting about the election was boring.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance meeting-2 Meeting) (refers meeting-2 election-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testMessageAbout() {
        ...
        String sent = " Email messages about various scams inundate our mailboxes.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance message-2 Message) (refers message-2 scam-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testMovieAbout() {
        ...
        String sent = " The movie about the Civil War was pretty good.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance movie-2 MotionPicture) (refers movie-2 war-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testMythAbout() {
        ...
        String sent = " The myth about the war is only growing.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance myth-2 NarrativeText) (refers myth-2 war-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testNoteAbout() {
        ...
        String sent = " He made notes about possible improvements.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance note-3 Stating) (refers note-3 improvement-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testObservationAbout() {
        ...
        String sent = " His observation about her behavior only led to more confusion.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance observation-3 Measuring) (refers observation-3 behavior-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testPerceptionAbout() {
        ...
        String sent = " Different people have different perceptions about the same situation.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance perception-5 Perception) (refers perception-5 situation-9))");
        doTest(sent,input,expected);
    }
    ...
    public void testPredictionAbout() {
        ...
        String sent = " The ancient prediction about the doomsday is well known.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance prediction-3 Predicting) (refers prediction-3 doomsday-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testProgramAbout() {
        ...
        String sent = " He got his degree from a program about literature.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance program-10 Plan) (refers program-10 literature-12))");
        doTest(sent,input,expected);
    }
    ...
    public void testQualmsAbout() {
        ...
        String sent = " He has no qualms about manhunt.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance qualm-5 EmotionalState) (refers qualm-5 manhunt-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testQueryAbout() {
        ...
        String sent = " The system can handle queries about general topics.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance query-5 Requesting) (refers query-5 topic-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testQuestionAbout() {
        ...
        String sent = " Any questions about the procedure should be directed to the doctor.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance question-2 Question) (refers question-2 procedure-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testRecommendationAbout() {
        ...
        String sent = " He gave me recommendations about good restaurants.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance recommendation-5 Requesting) (refers recommendation-5 restaurant-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testRumorAbout() {
        ...
        String sent = " Rumors about imminent terrorist attacks abound.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance rumor-1 HistoricalAccount) (refers rumor-1 attack-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testScenarioAbout() {
        ...
        String sent = " A hypothetical scenario about fire in the building is the topic of the exercise.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance scenario-3 Text) (refers scenario-3 fire-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testSignalAbout() {
        ...
        String sent = " We are receiving signals about climate change.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance signal-4 Icon) (refers signal-4 climate-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testSnobberyAbout() {
        ...
        String sent = " Snobbery about modern art is often observed.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance snobbery-1 TraitAttribute) (refers snobbery-1 art-4))");
        doTest(sent,input,expected);
    }
    ...
    public void testStatementAbout() {
        ...
        String sent = " A statement about the government's position on the issue is long overdue.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance statement-2 Statement) (refers statement-2 position-7))");
        doTest(sent,input,expected);
    }
    ...
    public void testStoryAbout() {
        ...
        String sent = " Pinocchio is a story about a wooden puppet who wanted to become a boy.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance story-4 Stating) (refers story-4 puppet-8))");
        doTest(sent,input,expected);
    }
    ...
    public void testSuggestionAbout() {
        ...
        String sent = " The author's suggestions about marketing are highly useful.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance suggestion-4 Requesting) (refers suggestion-4 marketing-6))");
        doTest(sent,input,expected);
    }
    ...
    public void testTestimonyAbout() {
        ...
        String sent = " In his public testimony about the accident, Sullivan gave conflicting accounts.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance testimony-6 Testifying) (refers testimony-6 accident-9))");
        doTest(sent,input,expected);
    }
    ...
    public void testTransparencyAbout() {
        ...
        String sent = " There is often a lack of transparency about governmental decision-making.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance transparency-7 Icon) (refers transparency-7 decision-making-10))");
        doTest(sent,input,expected);
    }
    ...
    public void testTrialAbout() {
        ...
        String sent = "The trial about the murder case became a global sensation.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance trial-2 Experimenting) (refers trial-2 murder-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testViewAbout() {
        ...
        String sent = "His view about the matter clashes with those of many other senators.";
        String input = "root(ROOT-0,view-2), poss(view-2,he-1), prep_with(view-2,those-8), " +
                "amod(senator-12,many-10), amod(senator-12,other-11), prep_of(those-8,senator-12), " +
                "det(matter-5,the-4), prep_about(view-2,matter-5), sumo(Position,senator-12), " +
                "sumo(Proposition,view-2), number(SINGULAR,view-2), number(SINGULAR,matter-5), " +
                "number(PLURAL,clash-6), number(PLURAL,senator-12)";
        Set<String> expected = Sets.newHashSet("(and (instance view-2 Proposition) (refers view-2 matter-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testWordAbout() {
        ...
        String sent = "The police chief did not give the reporters any word about the case.";
        ...
        Set<String> expected = Sets.newHashSet("(and (instance word-10 Word) (refers word-10 case-13))");
        doTest(sent,input,expected);
    }
    ...
    public void testWritingAbout() {
        ...
        Set<String> expected = Sets.newHashSet("(and (instance writings-2 Writing) (refers writings-2 legend-5))");
        doTest(sent,input,expected);
    }
    ...
    public void testWritingAboutUnify() {
        ...
        String sent = " His writings about medieval legends became popular.";
        String input = "root(ROOT-0,become-6), poss(writings-2,he-1), nsubj(become-6,writings-2), " +
                "amod(legend-5,medieval-4), prep_about(writings-2,legend-5), acomp(become-6,popular-7), " +
                "sumo(Writing,writings-2), sumo(TimeInterval,medieval-4), sumo(FictionalText,legend-5), " +
                "sumo(SubjectiveWeakPositiveAttribute,popular-7), number(PLURAL,writings-2), " +
                "number(PLURAL,legend-5), tense(PAST,become-6)";
        CNF cnfInput = new CNF(input);
        String rule = "prep_about(?X,?Y), sumo(?C,?X), isSubclass(?C,ContentDevelopment) ==> {(and\n" +
                "  (instance ?X ContentDevelopment)\n" +
                "  (refers ?X ?Y))}. ";
        Rule r = new Rule(rule);
        Subst bindings = r.cnf.unify(cnfInput);
        System.out.println("testWritingAboutUnify() input: " + input);
        System.out.println("testWritingAboutUnify() rule: " + rule);
        System.out.println("testWritingAboutUnify() bindings: " + bindings);
        assertTrue(bindings.toString().equals("{?X=writings-2, ?Y=legend-5, ?C=Writing}"));
        //Set<String> expected = Sets.newHashSet("(and (instance writings-2 Writing) (refers writings-2 legend-5))");
        //doTest(sent,input,expected);
    }

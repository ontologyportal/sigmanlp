...
public class UnificationTest extends IntegrationTestBase {
    ...
    private void doTest(String sent, String input, Set<String> expectedOutput) {
        ...
        System.out.println("\n\nUnificationTest: actual: " + (new TreeSet(cleanedActual)));
        System.out.println("UnificationTest: expected: " + (new TreeSet(expectedOutput)));
    ...
    public void testUnifyWhatDidMaryKick() {
        ...
        String sent = "What did Mary kick?";
    ...
    public void testUnifyWasAmeliaMaryEarhartAFemale() {
        ...
        String sent = "Was Amelia Mary Earhart a female?";
    ...
    public void testWhereDidAmeliaMaryEarhartLive() {
        ...
        String sent = "Where did Amelia Mary Earhart live?";
        String input = "root(ROOT-0, live-6), advmod(live-6, where-1), " +
                "aux(live-6, do-2), nsubj(live-6, AmeliaMaryEarhart-3), " +
                "attribute(AmeliaMaryEarhart-3, Female), sumo(IntentionalProcess, do-2), " +
                "sumo(Living, live-6), names(AmeliaMaryEarhart-3, \"Amelia Mary Earhart\"), " +
                "sumo(Human, AmeliaMaryEarhart-3), number(SINGULAR, Amelia-3), " +
                "number(SINGULAR, Mary-4), number(SINGULAR, Earhart-5)";
        Set<String> expected = Sets.newHashSet(
    ...
    public void testWhenWasAmeliaMaryEarhartBorn() {
        ...
        String sent = "When was Amelia Mary Earhart born?";
    ...
    public void testWhatWasAmeliaMaryEarhartInterestedIn() {
        ...
        String sent = "What was Amelia Mary Earhart interested in?";
    ...
    public void testWasAmeliaMaryEarhartInterestedInAirplanes() {
        ...
        String sent = "Was Amelia Mary Earhart interested in airplanes?";
    ...
    public void testWhereDidSheDisappear() {
        ...
        String input = "root(ROOT-0,disappear-4), advmod(disappear-4,where-1), " +
                "aux(disappear-4,do-2), nsubj(disappear-4,Earhart-3), " +
                "sumo(Human,Earhart-3), names(Earhart-3,\"Earhart\"), " +
                "sumo(IntentionalProcess,do-2), sumo(Disappearing,disappear-4), " +
                "number(SINGULAR,Earhart-3)";
        Set<String> expected = Sets.newHashSet(
    ...
    public void testWhenDidEarhartDisappear() {
        ...
        String input = "root(ROOT-0,disappear-4), advmod(disappear-4,when-1), " +
                "aux(disappear-4,do-2), nsubj(disappear-4,Earhart-3), " +
                "sumo(Human,Earhart-3), names(Earhart-3,\"Earhart\"), " +
                "sumo(IntentionalProcess,do-2), sumo(Disappearing,disappear-4), number(SINGULAR,Earhart-3)";
        Set<String> expected = Sets.newHashSet(
                "(time disappear-4 ?WH)",
                "(agent disappear-4 Earhart-3)",
                "(names Earhart-3 \"Earhart\")",
